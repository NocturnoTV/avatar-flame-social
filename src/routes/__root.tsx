...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://bloxspark.app/bloxspark-icon.svg" },
    ...
    links: [
      ...
      { rel: "icon", type: "image/svg+xml", href: "/bloxspark-icon.svg?v=3" },
      { rel: "apple-touch-icon", href: "/bloxspark-icon.svg?v=3" },
