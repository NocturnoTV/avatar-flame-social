  ...
  component: () => (
    <LegalPage title="Règles de la communauté" updated="Dernière mise à jour : 12 septembre 2026">
      <LegalSection title="L'esprit Bloxspark">
        <p>
          Bloxspark est fait pour rencontrer d'autres joueuses et joueurs de Roblox, parler de vos jeux
          préférés, former des équipes et créer des amitiés. Tout le monde doit s'y sentir en sécurité, quel
          que soit son âge, son pays, sa langue ou son style de jeu.
        </p>
      </LegalSection>
      ...
      <LegalSection title="2. Protection des mineurs">
        <ul>
          <li>Interdit aux moins de 13 ans. De 13 à 17 ans, l'accord d'un parent est obligatoire.</li>
          <li>Aucun contenu sexuel ou suggestif, jamais, sous aucune forme.</li>
          <li>
            Un adulte qui tient des propos déplacés à un mineur est exclu définitivement et peut être
      ...
      <LegalSection title="3. Protège tes informations">
        <ul>
          ...
          <li>Ne donne pas ton adresse, ton école, ton numéro de téléphone ni tes coordonnées bancaires.</li>
          <li>Méfie-toi des liens envoyés en message : les arnaques aux Robux gratuits sont fréquentes.</li>
        </ul>
      </LegalSection>
      ...
      <LegalSection title="6. Signaler et bloquer">
        <p>
          Si un comportement te met mal à l'aise, utilise le bouton de signalement sur le profil ou la
          conversation, puis bloque la personne. Les signalements sont examinés et peuvent entraîner un
          avertissement, une suspension ou une exclusion définitive. Si tu es en danger, parles-en à un adulte
          de confiance et contacte les services d'urgence de ton pays.
        </p>
      </LegalSection>
      ...
      <LegalSection title="7. Conséquences">
        <p>
          ...
          (contenus impliquant des mineurs, menaces, arnaques organisées) entraînent une exclusion immédiate
